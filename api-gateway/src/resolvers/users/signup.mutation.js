...
const signup = {
  ...
  validationSchema: yup.object().shape({
    data: yup.object().shape({
      name: yup.string().trim().required('Name is a required field.').min('2', 'Name should at least be 2 characters.')
      ...
      password: yup.string().trim().required('Password is a required field.').min('8', 'Password should at least be 8 characters.')
